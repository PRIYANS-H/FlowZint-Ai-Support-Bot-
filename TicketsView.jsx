...
export function TicketsView({ tickets }) {
            ...
            <>
              ...
              >
                ...
                <td style={{ padding: "10px 10px", color: "var(--color-text-tertiary)", fontSize: 11 }}>
                  {t.ts}
                  <span style={{ float: "right", fontSize: 10, color: "var(--color-text-tertiary)" }}>
                    <i className={`ti ti-chevron-${expandedId === t.id ? "up" : "down"}`} />
                  </span>
                </td>
              </tr>
              {expandedId === t.id && (
                <tr key={`${t.id}-notes`} style={{ borderBottom: "0.5px solid var(--color-border-tertiary)" }}>
